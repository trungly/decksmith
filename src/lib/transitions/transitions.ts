 ...
 */
export type SlideRelativePosition =
  | "current"
  | "past-h"
  | "future-h"
  | "past-v"
...
const TRANSITION_MAP: Record<
  TransitionType,
  Partial<Record<SlideRelativePosition, string>>
> = {
  none: {
  ...
  convex: {
    "past-h":
      "opacity: 0; transform: translate(-100%, 0) rotateY(-90deg); transform-origin: right center;",
    "future-h":
      "opacity: 0; transform: translate(100%, 0) rotateY(90deg); transform-origin: left center;",
    "past-v":
      "opacity: 0; transform: translate(0, -100%) rotateX(90deg); transform-origin: bottom center;",
    "future-v":
      "opacity: 0; transform: translate(0, 100%) rotateX(-90deg); transform-origin: top center;",
  },
  concave: {
    "past-h":
      "opacity: 0; transform: translate(-100%, 0) rotateY(90deg); transform-origin: right center;",
