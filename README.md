...
For a standard dev server without forcing host/port/browser open, use `bun run dev`.
...
| `contentSize` | `"comfortable" \| "cozy" \| "compact"` | `"comfortable"` | How large slide body content feels (typography and slide padding scale together) |
